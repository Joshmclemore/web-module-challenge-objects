...
*/
console.log('task 1b', createMenuItem('Soda', 2, 'Drinks'));
console.log('task 1b', createMenuItem('Sandwich', 5, 'Lunch'));
console.log('task 1b', createMenuItem('Milk', 2, 'Drinks'));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
console.log('task 2', burger.discount("dog"));
///////////////Reviews (MVP)///////////////////
const reviews = [
...
// 1 param: array / return array[array.length -1]
